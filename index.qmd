---
title: "STA HOUSE Statistical Methods in Research"
...
library(stringr)
gs4_deauth()
d <- read_sheet("https://docs.google.com/spreadsheets/d/1WkD0rywxNUx-EKYAVUVvUU1GAzXFhmQ9e4uz6Lc0lck/edit?usp=sharing")
prepare_cutoff_date <- as.Date("2026-12-31")
```
...
d |>
  ...
  mutate(
    date = as.Date(date),
    prepare = if_else(is.na(prepare), prepare, prepare |>
                        str_replace_all("\\\\n", "\n") |>
                        str_trim()),
